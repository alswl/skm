...
func repoLifecycleOpts(opts LifecycleOptions) repository.LifecycleOptions {
	return repository.LifecycleOptions{Force: opts.Force, DryRun: opts.DryRun}
}
...
func (s *Services) Archive(ctx context.Context, name string, opts LifecycleOptions) (*LifecycleResult, error) {
	...
	newPath, err := s.Repo.Archive(ctx, entry, repoLifecycleOpts(opts))
	if err != nil {
		return nil, err
	}
...
func (s *Services) Unarchive(ctx context.Context, name string, opts LifecycleOptions) (*LifecycleResult, error) {
	...
	newPath, err := s.Repo.Unarchive(ctx, entry, repoLifecycleOpts(opts))
	if err != nil {
		return nil, err
	}
...
func (s *Services) Delete(ctx context.Context, name string, opts LifecycleOptions) (*LifecycleResult, error) {
	...
	if err := s.Repo.Delete(ctx, entry, repoLifecycleOpts(opts)); err != nil {
		return nil, err
	}
